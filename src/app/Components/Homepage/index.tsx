      ...
      <div className="min-h-screen bg-[#0A3141] flex flex-col items-center justify-center">
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 bg-[#F2E5DA] p-10 rounded-lg shadow-lg">
            ...
            Hello, <span className="text-[#C17F59]">My name is</span>
          </p>
          ...
          <p className="text-gray-600 text-lg">
              I&apos;m a Professional Software Developer based in Rwanda. I strive to develop predictive analytics models and mobile applications to effectively identify poaching hotspots through creative solutions and user-centric design.
            </p>
             

              <div className="flex space-x-5 pt-6">
                <a href="https://www.linkedin.com/in/mutesi-aline-0517902b4/" 
                  target="_blank" 
                ...
                <a href="https://x.com/aline_mutesii" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-[#002E29] p-3 rounded-full hover:opacity-80 transition-opacity">
                  <Image src="/images/Twitter.svg" alt="Twitter" width={28} height={28} />
                </a>
                <a href="https://github.com/Mutesi-alin" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-[#002E29] p-3 rounded-full hover:opacity-80 transition-opacity">
